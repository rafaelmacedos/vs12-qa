...
public class PostEndpointTest {
    ...
    @Test // CT-07 - Cadastro bem-sucedido (QwYgpCs6AEtrzuBT -> id gerado)
    public void testCadastrarProdutoComSucesso() {
        // Massa de Dados
        ProdutoPostPojo produtoEnviado = new ProdutoPostPojo();
        produtoEnviado.setNome("Nike SHOWAirMax");
        produtoEnviado.setPreco(399);
        produtoEnviado.setDescricao("Tênis esportivo");
        produtoEnviado.setQuantidade(23);
